...
function get_clothing_description(clothing) {
  ...
  debug("DEBUG: clothing = " + clothing)

  description += create_description_data(clothing, "head", null, true, true);
  description += create_description_data(clothing, "torso", null, true, true);
  description += create_description_data(clothing, "hands", null, true, true);
  description += create_description_data(clothing, "legs", null, true, true);
